...
```{r 5-tabular-data-spatial-data, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Tabular and spatial data are related by a Relational Database Management System (RDBMS) in a Geographic Information System (GIS). Images of Douglas-Fir and Western Hemlock trees by Natural Resources Canada, Canadian Forest Service, modified with permission.")
...
```{r 5-boolean-and, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Boolean A AND B returns the area shaded blue. Pickell, CC-BY-SA-4.0.")
...
```{r 5-boolean-or, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Boolean A OR B returns the area shaded blue. Pickell, CC-BY-SA-4.0.")
...
```{r 5-boolean-not, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Boolean A NOT B returns the area shaded blue.. Pickell, CC-BY-SA-4.0.")
...
```{r 5-boolean-xor, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Boolean A XOR B returns the area shaded blue. Pickell, CC-BY-SA-4.0.")
...
```{r 5-join-cardinality, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Cardinality of joins between relations R and S. Pickell, CC-BY-SA-4.0.")
...
```{r 5-situational-vulnerability-leaflet, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
fig_cap <- paste("An example of choropleth map displaying the situational vulnerability scores in the City of Vancouver at DA level. Higher score represents the DA has higher situational vulnerable population (e.g., population lacking a high school diploma, low-income population.")
m
```
<br/>
...
fig_cap <- paste("An example of choropleth map displaying vegetation diversity for each dissemination area in Vancouver. Lam, CC-BY-SA-4.0.")
m1
```
<br/>
